...
-- insertar fichas
insert into `TABLA_FICHA`(`idFicha`,`IdMascota`,`IdUsuario`,`estado`,`descripcion`, `fecha`) values (1,2,3,"perdido", "zona parque", "18-03-18");
insert into `TABLA_FICHA`(`idFicha`,`IdMascota`,`IdUsuario`,`estado`,`descripcion`, `fecha`) values (2,3,2,"perdido", "sarmiento al 500", "18/05/18");
insert into `TABLA_FICHA`(`idFicha`,`IdMascota`,`IdUsuario`,`estado`,`descripcion`, `fecha`) values (3,4,1,"encontrado", "rivadavia al 100","15/02/18");
insert into `TABLA_FICHA`(`idFicha`,`IdMascota`,`IdUsuario`,`estado`,`descripcion`, `fecha`) values (4,1,5,"encontrado", "marconi al 1500","11/06/18");
insert into `TABLA_FICHA`(`idFicha`,`IdMascota`,`IdUsuario`,`estado`,`descripcion`, `fecha`) values (5,5,4,"encontrado", "mitre al 1400","1/07/18");
